...
public class Plansza {
    ...
    public boolean wykonajRuch(String pozycjaPoczatkowa, String pozycjaKoncowa, int gracz) {
        int wierszP = (int) (pozycjaPoczatkowa.charAt(0)) - 65;
        int kolumnaP = Integer.parseInt(pozycjaPoczatkowa.substring(1)) - 1;
        int wierszK = (int) (pozycjaKoncowa.charAt(0)) - 65;
        int kolumnaK = Integer.parseInt(pozycjaKoncowa.substring(1)) - 1;
        System.out.println("Gracz: " + (gracz + 1) + " wykonuje ruch: " + pozycjaPoczatkowa + " -> " + pozycjaKoncowa);
        System.out.println("Pod pozycją " + pozycjaPoczatkowa + " znajduje się " + sprawdzPole(wierszP, kolumnaP));
        System.out.println("Pod pozycją " + pozycjaKoncowa + " znajduje się " + sprawdzPole(wierszK, kolumnaK));
        return true;
    }
}
